// src/email/templates/email-test.tsx
import i18n2 from "i18next";
import { render, Text as Text2 } from "jsx-email";
...
var Template = ({ locale, t }) => {
  ...
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: "Here is a preview", locale, children: [
    ...
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-test.message") })
  ] });
};
